...
public class InfinityAssistScripts implements java.io.Serializable {
	...
	public static void setRequestDetailsforCopyOperation(
		...
		try {
			...
			kcontext.setVariable("isInitiatedApp", responseJSON.optString("isRMInitiatedApp").toString());
			kcontext.setVariable("createdBy", responseJSON.optString("CreatedBy").toString());
